...
class Sale extends CI_Controller {
	...
	{
		$data['sales']=$this->purchase->distinct_view_all_sales();		
		$data['title']='ECommerce | Sales';
		$data['mainContent']='admin/sale/index';
			...
			$getdata=$this->temp->edit($id);
				...
				foreach ($getdata as $key) {
					...
					echo '<tr>
						...
						<td>'.$key->price.'</td>
						<td>'.$key->total.'</td>
						<td><a class="deleteSaleEditTransaction"><button  type="button" class="btn btn-xs btn-danger">Delete</button></a></td>
					</tr>';
					$grand+=$key->total;
				}
				echo '<tr>				                        
